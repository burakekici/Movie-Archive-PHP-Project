      ...
      <div class="row">
        <div class="col-md-9">
		  ...
		  <br><br><br>
            ...
            <form class="form-signin"  method="POST" action = "deleteuser.php">
              <h2 class="form-signin-heading">Delete User</h2>
              <label for="inputMemberId" class="sr-only">User ID</label>
              ...
              if (!empty($_POST['inputMemberId'])){
                ...
                if( !oci_execute($stid) ) {
                  ...
                  oci_close($conn);
					...
					$stmt = "CALL ADD_LOG('An user with ID $id is deleted at $currentTime on $currentDate.')";
					$stid = oci_parse($conn, $stmt);
					oci_execute($stid);
					
                  echo "<div class=\"alert alert-success\"><strong>Success!</strong> User is deleted.</div>";
                }
              }
              ob_end_flush();
              ?>
