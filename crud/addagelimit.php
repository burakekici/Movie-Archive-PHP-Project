        ...
        <div class="col-md-9">
          ...
          <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
              ...
              <li class="active"><a href="addagelimit.php">Add Age Limit</a></li>
          ...
          <div class="col-sm-9 col-sm-offset-3 col-md-9 col-md-offset-3 main">
            ...
            // Prepare the query
            $stmt = "SELECT MOVIE.MOVIE_ID ,MOVIE.MOVIE_TITLE,AGELIMIT.AGELIMIT
					 FROM AGELIMIT RIGHT JOIN MOVIE ON AGELIMIT.AGELIMIT_ID=MOVIE.MOVIE_ID
		  ...
		  <br><br><br>
			...
			<form class="form-signin" method="POST" action = "addagelimit.php">
              ...
              if (!empty($_POST['inputMovieID']) && !empty($_POST['inputAgelimit'])  ){
                ...
                // prepare the query
                $stmt = "CALL ADD_AGELIMIT ('$id','$agelimit')";
				$stid = oci_parse($conn, $stmt);
                ...
                if( !oci_execute($stid) ) {
                  ...
                  oci_close($conn);
					...
					$stmt = "CALL ADD_LOG('A new agelimit \"$agelimit\" is added at $currentTime on $currentDate.')";
					$stid = oci_parse($conn, $stmt);
					oci_execute($stid);

                  echo "<div class=\"alert alert-success\"><strong>Success!</strong> $agelimit is added.</div>";
                }
              ...
              <h2 class="form-signin-heading">Add Agelimit</h2>
              ...
              <br>
			  <button class="btn btn-lg btn-primary btn-block" type="submit">Add agelimit</button>
            </form>
