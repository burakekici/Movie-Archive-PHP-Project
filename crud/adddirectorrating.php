        ...
        <div class="col-md-9">
          ...
          <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
              ...
              <li class="active"><a href="adddirectorrating.php">Add Director Rating</a></li>
          ...
          <div class="col-sm-9 col-sm-offset-3 col-md-9 col-md-offset-3 main">
			  ...
			  <h2 class="form-signin-heading">List Director Rating</h2>
		  ...
		  <br><br><br>
			...
			<form class="form-signin" method="POST" action = "adddirectorrating.php">
              ...
              if (!empty($_POST['inputDirectorID']) &&  !empty($_POST['inputDirectorrating']) ){
                ...
                // prepare the query
                $stmt = "CALL ADD_DIRECTOR_RATING ('$id','$memberID','$directorrating')";
				$stid = oci_parse($conn, $stmt);
                ...
                if( !oci_execute($stid) ) {
                  ...
                  oci_close($conn);
					...
					$stmt = "CALL ADD_LOG('A new director rate \"$directorrating\"  with director id \"$id\" member id \"$m_id\" is added at $currentTime on $currentDate.')";
					$stid = oci_parse($conn, $stmt);
					oci_execute($stid);

                  echo "<div class=\"alert alert-success\"><strong>Success!</strong> $directorrating is added as an director rate.</div>";
                }
              ...
              <h2 class="form-signin-heading">Add Director Rating</h2>
              ...
              <input type="directorrating" name="inputDirectorrating" id="inputDirectorrating" class="form-control" placeholder="Rate" required autofocus>
              <br>
			  <button class="btn btn-lg btn-primary btn-block" type="submit">Add director rate</button>
            </form>
