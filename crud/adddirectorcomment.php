        ...
        <div class="col-md-9">
          ...
          <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
              ...
              <li class="active"><a href="adddirectorcomment.php">Add Director Comment</a></li>
          ...
          <div class="col-sm-9 col-sm-offset-3 col-md-9 col-md-offset-3 main">
			  ...
			  <h2 class="form-signin-heading">List Director Comment</h2>
		  ...
		  <br><br><br>
			...
			<form class="form-signin" method="POST" action = "adddirectorcomment.php">
              ...
              if (!empty($_POST['inputDirectorID']) &&  !empty($_POST['inputDirectorcomment']) ){
                ...
                // prepare the query
                $stmt = "CALL ADD_DIRECTOR_COMMENT ('$id','$memberID','$directorcomment')";
				$stid = oci_parse($conn, $stmt);
                ...
                if( !oci_execute($stid) ) {
                  ...
                  oci_close($conn);
					...
					$stmt = "CALL ADD_LOG('A new director comment \"$directorcomment\"  with director id \"$id\" member id \"$m_id\" is added at $currentTime on $currentDate.')";
					$stid = oci_parse($conn, $stmt);
					oci_execute($stid);

                  echo "<div class=\"alert alert-success\"><strong>Success!</strong> $directorcomment is added as an director comment.</div>";
                }
              ...
              <h2 class="form-signin-heading">Add Director Comment</h2>

              <label for="inputDirectorID" class="sr-only">Directorid</label>
              <input type="id" name="inputDirectorID" id="inputDirectorID" class="form-control" placeholder="Director id" required autofocus>
              <br>
              <label for="inputDirectorcomment" class="sr-only">Comment</label>
              <input type="directorcomment" name="inputDirectorcomment" id="inputDirectorcomment" class="form-control" placeholder="Comment" required autofocus>
              <br>
			  <button class="btn btn-lg btn-primary btn-block" type="submit">Add director comment</button>
            </form>
