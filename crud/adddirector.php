        ...
        <div class="col-md-9">
          ...
          <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
              ...
              <li class="active"><a href="adddirector.php">Add Director</a></li>
          ...
          <div class="col-sm-9 col-sm-offset-3 col-md-9 col-md-offset-3 main">
            <form class="form-signin" method="POST" action = "adddirector.php">
              ...
              if (!empty($_POST['inputDirectorname']) && !empty($_POST['inputDirectorsurname']) && !empty($_POST['inputAge']) && !empty($_POST['inputHometown'])){
                ...
                // prepare the query
                $stmt = "CALL ADD_DIRECTOR ('$directorname','$directorsurname','$age','$hometown')";
                ...
                if( !oci_execute($stid) ) {
                  ...
                  oci_close($conn);
					...
					$stmt = "CALL ADD_LOG('A new director with directorname \"$directorname\" is added at $currentTime on $currentDate.')";
					$stid = oci_parse($conn, $stmt);
					oci_execute($stid);

                  echo "<div class=\"alert alert-success\"><strong>Success!</strong> $directorname is added as an director.</div>";
                }
              }
              ob_end_flush();
              ?>
              ...
              <h2 class="form-signin-heading">Add Director</h2>
              ...
              <br>
              <button class="btn btn-lg btn-primary btn-block" type="submit">Add director</button>
            </form>
