        ...
        <div class="col-md-9">
          ...
          <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
              ...
              <li class="active"><a href="addgenre.php">Add Genre</a></li>
          ...
          <div class="col-sm-9 col-sm-offset-3 col-md-9 col-md-offset-3 main">
            ...
            // Prepare the query
            $stmt = "SELECT MOVIE.MOVIE_ID ,MOVIE.MOVIE_TITLE,GENRE.GENRE_CONTEXT
					 FROM GENRE RIGHT JOIN MOVIE ON GENRE.GENRE_ID=MOVIE.MOVIE_ID
		  ...
		  <br><br><br>
			...
			<form class="form-signin" method="POST" action = "addgenre.php">
              ...
              // Add genre
              if (!empty($_POST['inputGenreID']) && !empty($_POST['inputGenrecontext']) ){
                $id = ($_POST['inputGenreID']);
                $genrecontext = ($_POST['inputGenrecontext']);

                // prepare the query
                $stmt = "CALL ADD_GENRE ('$id','$genrecontext')";
				$stid = oci_parse($conn, $stmt);
                ...
                if( !oci_execute($stid) ) {
                  ...
                  oci_close($conn);
					...
					$stmt = "CALL ADD_LOG('A new genre \"$genrecontext\"  with movie id \"$id\" is added at $currentTime on $currentDate.')";
					$stid = oci_parse($conn, $stmt);
					oci_execute($stid);

                  echo "<div class=\"alert alert-success\"><strong>Success!</strong> $genrecontext is added as an genre.</div>";
                }
              ...
              <label for="inputGenreID" class="sr-only">Genreid</label>
              <input type="id" name="inputGenreID" id="inputGenreID" class="form-control" placeholder="Genre id" required autofocus>
              <br>
              <label for="inputGenrecontext" class="sr-only">Genre</label>
              <input type="genrecontext" name="inputGenrecontext" id="inputGenrecontext" class="form-control" placeholder="Genre" required autofocus>
              <br>
