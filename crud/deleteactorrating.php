        ...
        <div class="col-md-9">
          ...
          <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
              ...
              <li class="active"><a href="deleteactorrating.php">Delete Actor Rating</a></li>
              <br>
			  <!-- 18 director rating -->
          ...
          <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-3 main">
            ...
            <h2 class="form-signin-heading">List of Actor Ratings</h2>
		  ...
		  <br><br><br>
            ...
            <form class="form-signin"  method="POST" action = "deleteactorrating.php">
              <h2 class="form-signin-heading">Delete Actor Rating</h2>
              ...
              if (!empty($_POST['inputActorID'])){
                ...
                // prepare the query
                $stmt = "CALL DELETE_ACTOR_RATING ('$id','$memberID')";
                $stid = oci_parse($conn, $stmt);
                ...
                if( !oci_execute($stid) ) {
                  ...
                  oci_close($conn);
					...
					$stmt = "CALL ADD_LOG('Rate with ID $id is deleted at $currentTime on $currentDate.')";
					$stid = oci_parse($conn, $stmt);
					oci_execute($stid);
					
                  echo "<div class=\"alert alert-success\"><strong>Success!</strong> Rate is deleted.</div>";
                }
              }
              ob_end_flush();
              ?>
