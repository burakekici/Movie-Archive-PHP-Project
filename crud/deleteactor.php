        ...
        <div class="col-md-9">
          ...
          <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
              ...
              <li class="active"><a href="deleteactor.php">Delete Actor</a></li>
              <br>
              <!-- 10 director -->
		  ...
		  <br><br><br>
            ...
            <form class="form-signin"  method="POST" action = "deleteactor.php">
              <h2 class="form-signin-heading">Delete Actor</h2>
              ...
              if (!empty($_POST['inputActorId'])){
                ...
                if( !oci_execute($stid) ) {
                  ...
                  oci_close($conn);
					...
					$stmt = "CALL ADD_LOG('An actor with ID $id is deleted at $currentTime on $currentDate.')";
					$stid = oci_parse($conn, $stmt);
					oci_execute($stid);
					
                  echo "<div class=\"alert alert-success\"><strong>Success!</strong> Actor is deleted.</div>";
                }
              }
              ob_end_flush();
              ?>
