        ...
        <div class="col-md-9">
          ...
          <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
              ...
              <li class="active"><a href="deletemovie.php">Delete Movie</a></li>
              <br>
              <!-- 4 poster -->
		  ...
		  <br><br><br>
            ...
            <form class="form-signin"  method="POST" action = "deletemovie.php">
              <h2 class="form-signin-heading">Delete Movie</h2>
              ...
              if (!empty($_POST['inputMovieId'])){
                ...
                if( !oci_execute($stid) ) {
                  ...
                  oci_close($conn);
					...
					$stmt = "CALL ADD_LOG('An movie with ID $id is deleted at $currentTime on $currentDate.')";
					$stid = oci_parse($conn, $stmt);
					oci_execute($stid);
					
                  echo "<div class=\"alert alert-success\"><strong>Success!</strong> Movie is deleted.</div>";
                }
              }
              ob_end_flush();
              ?>
