        ...
        <div class="col-md-9">
          ...
          <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
              ...
              <li class="active"><a href="deletemoviecomment.php">Delete Movie Comment</a></li>
              <br>
			  <!-- 14 actor comment -->
		  ...
		  <br><br><br>
            ...
            <form class="form-signin"  method="POST" action = "deletemoviecomment.php">
              <h2 class="form-signin-heading">Delete Movie Comment</h2>
              ...
              if (!empty($_POST['inputMovieID'])){
                ...
                // prepare the query
                $stmt = "CALL DELETE_MOVIE_COMMENT ('$id','$memberID')";
                $stid = oci_parse($conn, $stmt);
