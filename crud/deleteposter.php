        ...
        <div class="col-md-9">
          ...
          <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
              ...
              <li class="active"><a href="deleteposter.php">Delete Poster</a></li>
              <br>
              <!-- 5 trailer -->
          ...
          <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-3 main">
            ...
            <h2 class="form-signin-heading">List of Poster Paths</h2>
            ...
            if( !oci_execute($stid) ) {
              ...
              echo "<thead> <tr> <th>ID</th> <th>Path</th> </tr> </thead>";
              // Print the results
		  ...
		  <br><br><br>
            ...
            <form class="form-signin"  method="POST" action = "deleteposter.php">
              <h2 class="form-signin-heading">Delete Poster</h2>
              <label for="inputPosterID" class="sr-only">Poster ID</label>
              <input type="number" name="inputPosterID" id="inputPosterID" class="form-control" placeholder="Poster ID" required autofocus>
              <br>
			  ...
			  // Delete admin
              if (!empty($_POST['inputPosterID'])){
                $id = ($_POST['inputPosterID']);
                
                // prepare the query
                $stmt = "CALL DELETE_POSTER ('$id')";
                $stid = oci_parse($conn, $stmt);
                ...
                if( !oci_execute($stid) ) {
                  ...
                  oci_close($conn);
					...
					$stmt = "CALL ADD_LOG('A poster with ID $id is deleted at $currentTime on $currentDate.')";
					$stid = oci_parse($conn, $stmt);
					oci_execute($stid);
					
                  echo "<div class=\"alert alert-success\"><strong>Success!</strong> Poster is deleted.</div>";
                }
              }
              ob_end_flush();
              ?>
