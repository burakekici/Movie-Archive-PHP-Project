        ...
        <div class="col-md-9">
          ...
          <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
              <li><a href="../adminpanel.php">Admşn Homepage</a></li>
              <br>
              <!-- 1 admin -->
          ...
          <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-3 main">
            ...
            // Prepare the query
            $stmt = "SELECT * FROM MEMBER WHERE MEMBER_TYPE = 2 ORDER BY MEMBER_ID";
		  ...
		  <br><br><br>
            ...
            <form class="form-signin" method="POST" action = "updateuser.php">
              <?php
              require_once '../config.php';
              ob_start();
              ...
              if (!empty($_POST['inputUsername']) && !empty($_POST['inputUsername']) && !empty($_POST['inputEmail']) && !empty($_POST['inputPassword']) && !empty($_POST['inputAge'])){
                ...
                if( !oci_execute($stid) ) {
                  ...
                  oci_close($conn);
					...
					$stmt = "CALL ADD_LOG('The user with ID $id is updated at $currentTime on $currentDate.')";
					$stid = oci_parse($conn, $stmt);
					oci_execute($stid);
