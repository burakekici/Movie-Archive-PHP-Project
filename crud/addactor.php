      ...
      <div class="row">
        <div class="col-md-9">
          ...
          <div class="col-sm-9 col-sm-offset-3 col-md-9 col-md-offset-3 main">
            <form class="form-signin" method="POST" action = "addactor.php">
              ...
              if (!empty($_POST['inputActorname']) && !empty($_POST['inputActorsurname']) && !empty($_POST['inputAge']) && !empty($_POST['inputHometown'])){
                ...
                // prepare the query
                $stmt = "CALL ADD_ACTOR ('$actorname','$actorsurname','$age','$hometown')";
                ...
                if( !oci_execute($stid) ) {
                  ...
                  oci_close($conn);
					...
					$stmt = "CALL ADD_LOG('A new actor with actorname \"$actorname\" is added at $currentTime on $currentDate.')";
					$stid = oci_parse($conn, $stmt);
					oci_execute($stid);

                  echo "<div class=\"alert alert-success\"><strong>Success!</strong> $actorname is added as an actor.</div>";
                }
              }
              ob_end_flush();
              ?>
              ...
              <h2 class="form-signin-heading">Add Actor</h2>
              ...
              <br>
              <button class="btn btn-lg btn-primary btn-block" type="submit">Add actor</button>
            </form>
