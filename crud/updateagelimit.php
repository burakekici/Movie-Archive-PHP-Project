        ...
        <div class="col-md-9">
          ...
          <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
              ...
              <li class="active"><a href="updateagelimit.php">Update Age Limit</a></li>
          ...
          <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-3 main">
            ...
            <h2 class="form-signin-heading">List of Age Limits</h2>
		  ...
		  <br><br><br>
            ...
            <form class="form-signin" method="POST" action = "updateagelimit.php">
              <?php
              require_once '../config.php';
              ob_start();
              
              // Update agelimit
              if (!empty($_POST['inputMovieID']) && !empty($_POST['inputAgelimit']) ){
                $id = ($_POST['inputMovieID']);
				$agelimit = ($_POST['inputAgelimit']);
                
                
                // prepare the query
                $stmt = "CALL UPDATE_AGELIMIT ('$id','$agelimit')";
                $stid = oci_parse($conn, $stmt);
                ...
                if( !oci_execute($stid) ) {
                  ...
                  oci_close($conn);
					...
					$stmt = "CALL ADD_LOG('The Movie age limit $agelimit with ID $id is updated at $currentTime on $currentDate.')";
					$stid = oci_parse($conn, $stmt);
					oci_execute($stid);
					
                  echo "<div class=\"alert alert-success\"><strong>Success!</strong> $agelimit is updated.</div>";
                }
              }
              ob_end_flush();
              ?>
              
              <h2 class="form-signin-heading">Update Agelimit</h2>	
              ...
              <br>
              <label for="inputAgelimit" class="sr-only">Agelimit</label>
              <input type="agelimit" name="inputAgelimit" id="inputAgelimit" class="form-control" placeholder="Agelimit" required autofocus>
              <br>
              <button class="btn btn-lg btn-primary btn-block" type="submit">Update agelimit</button>
