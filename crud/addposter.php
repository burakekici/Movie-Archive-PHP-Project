    ...
    <div class="row">
        ...
        <div class="row">
            <div class="col-md-9">
              ...
              <li class="active"><a href="addposter.php">Add Poster</a></li>
              ...
              <li><a href="deletedirectorrating.php">Delete Director Rating</a></li>
                ...
                <div class="col-sm-9 col-sm-offset-3 col-md-9 col-md-offset-3 main">
                    <h4 class="page-header">Add Poster</h4>
            ...
            // Prepare the query
            $stmt = "SELECT MOVIE.MOVIE_ID ,MOVIE.MOVIE_TITLE,POSTER.POSTER_PATH
					 FROM POSTER RIGHT JOIN MOVIE ON POSTER.POSTER_ID=MOVIE.MOVIE_ID
            ...
            if( !oci_execute($stid) ) {
              ...
              echo "<thead> <tr> <th>ID</th> <th>Movie</th> <th>Poster Path</th> </tr> </thead>";
              // Print the results
		  ...
		  <br><br><br>
                    ...
                    <form enctype="multipart/form-data" action="addposter.php" method="post" name="changer">

					<label for="inputID" class="sr-only">Movie ID</label>
              <input type="number" name="inputID" id="inputID" class="form-control" placeholder="Movie ID" required autofocus>
                        ...
                        if (!empty($_POST['inputID']) && isset($_FILES["fileToUpload"]["name"])) {
                            ...
                            if (!empty($name)) {
                                ...
                                if (move_uploaded_file($tmp_name, $location . $name)) {
                                    ...
                                    $stmt = "CALL ADD_POSTER ('$id','$imgpath')";
                                    $stid = oci_parse($conn, $stmt);
                                    ...
                                    if (!oci_execute($stid)) {
                                        ...
                                        $stmt = "CALL ADD_LOG('A new poster is added at $currentTime on $currentDate.')";
                                        $stid = oci_parse($conn, $stmt);
                                        oci_execute($stid);
                        ...
                        /*if (isset($_FILES["image"]["error"] > 0)) {
                            echo "<div class=\"alert alert-danger\"><strong>Failed!</strong>Please select a proper image.</div>";
						} else {
                            move_uploaded_file($_FILES["image"]["tmp_name"], "../images/" . $_FILES["image"]["name"]);
                            echo "<div class=\"alert alert-success\"><strong>Success!</strong>Saved.</div>";
                            $file = "../images/" . $_FILES["image"]["name"];

                            $stmt = "CALL ADD_POSTER ('1','$file')";
                            $stid = oci_parse($conn, $stmt);
