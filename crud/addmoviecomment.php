        ...
        <div class="col-md-9">
          ...
          <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
              ...
              <li class="active"><a href="addmoviecomment.php">Add Movie Comment</a></li>
          ...
          <div class="col-sm-9 col-sm-offset-3 col-md-9 col-md-offset-3 main">
			  ...
			  <h2 class="form-signin-heading">List Movie Comment</h2>
		  ...
		  <br><br><br>
			...
			<form class="form-signin" method="POST" action = "addmoviecomment.php">
              ...
              if (!empty($_POST['inputMovieID']) &&  !empty($_POST['inputMoviecomment']) ){
                ...
                // prepare the query
                $stmt = "CALL ADD_MOVIE_COMMENT ('$id','$memberID','$moviecomment')";
				$stid = oci_parse($conn, $stmt);
                ...
                if( !oci_execute($stid) ) {
                  ...
                  oci_close($conn);
					...
					$stmt = "CALL ADD_LOG('A new movie comment \"$moviecomment\"  with movie id \"$id\" member id \"$m_id\" is added at $currentTime on $currentDate.')";
					$stid = oci_parse($conn, $stmt);
					oci_execute($stid);

                  echo "<div class=\"alert alert-success\"><strong>Success!</strong> $moviecomment is added as an movie comment.</div>";
                }
              ...
              <h2 class="form-signin-heading">Add Movie Comment</h2>
              ...
              <input type="moviecomment" name="inputMoviecomment" id="inputMoviecomment" class="form-control" placeholder="Comment" required autofocus>
              <br>
			  <button class="btn btn-lg btn-primary btn-block" type="submit">Add movie comment</button>
            </form>
