        ...
        <div class="col-md-9">
          ...
          <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
              ...
              <li class="active"><a href="addactorrating.php">Add Actor Rating</a></li>
          ...
          <div class="col-sm-9 col-sm-offset-3 col-md-9 col-md-offset-3 main">
			  ...
			  <h2 class="form-signin-heading">List Actor Rating</h2>
            ...
            if( !oci_execute($stid) ) {
              ...
              echo "<thead> <tr> <th>ID</th> <th>Actor</th> <th></th> <th>Member ID</th> <th>Member</th> <th>Rate</th></tr> </thead>";
              // Print the results
		  ...
		  <br><br><br>
			...
			<form class="form-signin" method="POST" action = "addactorrating.php">
              ...
              if (!empty($_POST['inputActorID']) &&  !empty($_POST['inputActorrating']) ){
                ...
                // prepare the query
                $stmt = "CALL ADD_ACTOR_RATING ('$id','$memberID','$actorrating')";
				$stid = oci_parse($conn, $stmt);
                ...
                if( !oci_execute($stid) ) {
                  ...
                  oci_close($conn);
					...
					$stmt = "CALL ADD_LOG('A new actor rate \"$actorrating\"  with actor id \"$id\" member id \"$memberID\" is added at $currentTime on $currentDate.')";
					$stid = oci_parse($conn, $stmt);
					oci_execute($stid);

                  echo "<div class=\"alert alert-success\"><strong>Success!</strong> $actorrating is added as an actor rate.</div>";
                }
              ...
              <h2 class="form-signin-heading">Add Actor Rating</h2>
              ...
              <input type="actorrating" name="inputActorrating" id="inputActorrating" class="form-control" placeholder="Rate" required autofocus>
              <br>
			  <button class="btn btn-lg btn-primary btn-block" type="submit">Add actor rate</button>
            </form>
