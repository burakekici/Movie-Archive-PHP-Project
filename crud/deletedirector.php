        ...
        <div class="col-md-9">
          ...
          <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
              ...
              <li class="active"><a href="deletedirector.php">Delete Director</a></li>
              <br>
			  <!-- 11 movie actor -->
		  ...
		  <br><br><br>
            ...
            <form class="form-signin"  method="POST" action = "deletedirector.php">
              <h2 class="form-signin-heading">Delete Director</h2>
              ...
              if (!empty($_POST['inputDirectorId'])){
                ...
                if( !oci_execute($stid) ) {
                  ...
                  oci_close($conn);
					...
					$stmt = "CALL ADD_LOG('An director with ID $id is deleted at $currentTime on $currentDate.')";
					$stid = oci_parse($conn, $stmt);
					oci_execute($stid);
					
                  echo "<div class=\"alert alert-success\"><strong>Success!</strong> Director is deleted.</div>";
                }
              }
              ob_end_flush();
              ?>
