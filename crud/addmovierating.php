...
/*$stmt = "SELECT * FROM MOVIE_RATING WHERE MEMBER_ID = '$memberID' AND MOVIE_ID= '$id'";
        ...
        <div class="col-md-9">
          ...
          <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
              ...
              <li class="active"><a href="addmovierating.php">Add Movie Rating</a></li>
          ...
          <div class="col-sm-9 col-sm-offset-3 col-md-9 col-md-offset-3 main">			
			  ...
			  <h2 class="form-signin-heading">List Movie Rating</h2>
		  ...
		  <br><br><br>
			...
			<form class="form-signin" method="POST" action = "addmovierating.php">
              ...
              if (!empty($_POST['inputMovieID']) &&  !empty($_POST['inputMovierating']) ){
                ...
                // prepare the query
                $stmt = "CALL ADD_MOVIE_RATING ('$id','$memberID','$movierating')";
				$stid = oci_parse($conn, $stmt);
                ...
                if( !oci_execute($stid) ) {
                  ...
                  oci_close($conn);
					...
					$stmt = "CALL ADD_LOG('A new movie rate \"$movierating\"  with movie id \"$id\" member id \"$m_id\" is added at $currentTime on $currentDate.')";
					$stid = oci_parse($conn, $stmt);
					oci_execute($stid);
					
                  echo "<div class=\"alert alert-success\"><strong>Success!</strong> $movierating is added as an movie rate.</div>";
                }
              ...
              <h2 class="form-signin-heading">Add Movie Rate</h2>		
              
              <label for="inputMovieID" class="sr-only">Movieid</label>
              <input type="id" name="inputMovieID" id="inputMovieID" class="form-control" placeholder="Movie id" required autofocus>
              <br>
              <label for="inputMovierating" class="sr-only">Comment</label>
              <input type="movierate" name="inputMovierating" id="inputMovierating" class="form-control" placeholder="Rate" required autofocus>
              <br>
			  <button class="btn btn-lg btn-primary btn-block" type="submit">Add movie rate</button>
            </form>
