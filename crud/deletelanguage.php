        ...
        <div class="col-md-9">
          ...
          <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
              ...
              <li class="active"><a href="deletelanguage.php">Delete Language</a></li>
              <br>
              <!-- 9 actor -->
		  ...
		  <br><br><br>
            ...
            <form class="form-signin"  method="POST" action = "deletelanguage.php">
              <h2 class="form-signin-heading">Delete Language</h2>
              <label for="inputMovieID" class="sr-only">Language ID</label>
              ...
              if (!empty($_POST['inputMovieID'])){
                ...
                if( !oci_execute($stid) ) {
                  ...
                  oci_close($conn);
					...
					$stmt = "CALL ADD_LOG('Language with ID $id is deleted at $currentTime on $currentDate.')";
					$stid = oci_parse($conn, $stmt);
					oci_execute($stid);
					
                  echo "<div class=\"alert alert-success\"><strong>Success!</strong> Language is deleted.</div>";
                }
              }
              ob_end_flush();
              ?>
