        ...
        <div class="col-md-9">
          ...
          <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
              ...
              <li class="active"><a href="addstoryline.php">Add Storyline</a></li>
          ...
          <div class="col-sm-9 col-sm-offset-3 col-md-9 col-md-offset-3 main">
            ...
            // Prepare the query
            $stmt = "SELECT MOVIE.MOVIE_ID ,MOVIE.MOVIE_TITLE,STORYLINE.STORYLINE_CONTEXT
					 FROM STORYLINE RIGHT JOIN MOVIE ON STORYLINE.STORYLINE_ID=MOVIE.MOVIE_ID
		  ...
		  <br><br><br>
			...
			<form class="form-signin" method="POST" action = "addstoryline.php">
              ...
              if (!empty($_POST['inputStorylineID']) && !empty($_POST['inputStorylinecontext']) ){
                ...
                // prepare the query
                $stmt = "CALL ADD_STORYLINE ('$id','$storylinecontext')";
				$stid = oci_parse($conn, $stmt);
                ...
                if( !oci_execute($stid) ) {
                  ...
                  oci_close($conn);
					...
					$stmt = "CALL ADD_LOG('A new storyline \"$storylinecontext\"  with movie id \"$id\" is added at $currentTime on $currentDate.')";
					$stid = oci_parse($conn, $stmt);
					oci_execute($stid);

                  echo "<div class=\"alert alert-success\"><strong>Success!</strong> $storylinecontext is added as an storyline.</div>";
                }
              ...
              <h2 class="form-signin-heading">Add Storyline</h2>

              <label for="inputStorylineID" class="sr-only">Storylineid</label>
              <input type="id" name="inputStorylineID" id="inputStorylineID" class="form-control" placeholder="Storyline id" required autofocus>
              <br>
              <label for="inputStorylinecontext" class="sr-only">Storyline</label>
              <input type="storylinecontext" name="inputStorylinecontext" id="inputStorylinecontext" class="form-control" placeholder="Storyline" required autofocus>
              <br>
			  <button class="btn btn-lg btn-primary btn-block" type="submit">Add Storyline</button>
            </form>
