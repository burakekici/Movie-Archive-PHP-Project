        ...
        <div class="col-md-9">
          ...
          <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
              ...
              <li class="active"><a href="updatelanguage.php">Update Language</a></li>
          ...
          <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-3 main">
            ...
            <h2 class="form-signin-heading">List of Languages</h2>
            ...
            // Prepare the query
            $stmt = "SELECT l.LANGUAGE_ID,m.MOVIE_TITLE,l.LANGUAGE FROM LANGUAGE l,MOVIE m WHERE m.MOVIE_ID=l.LANGUAGE_ID ORDER BY l.LANGUAGE_ID ";
            ...
            if( !oci_execute($stid) ) {
              ...
              echo "<thead> <tr> <th>ID</th> <th>Movie</th> <th>Languages</th> </tr> </thead>";
              // Print the results
		  ...
		  <br><br><br>
            ...
            <form class="form-signin" method="POST" action = "updatelanguage.php">
              <?php
              require_once '../config.php';
              ob_start();
              
              // Update movie
              if (!empty($_POST['inputMovieID']) && !empty($_POST['inputLanguage']) ){
                $id = ($_POST['inputMovieID']);
				$language = ($_POST['inputLanguage']);
                
                
                // prepare the query
                $stmt = "CALL UPDATE_LANGUAGE ('$id','$language')";
                $stid = oci_parse($conn, $stmt);
                ...
                if( !oci_execute($stid) ) {
                  ...
                  oci_close($conn);
					...
					$stmt = "CALL ADD_LOG('The Movie language $language with ID $id is updated at $currentTime on $currentDate.')";
					$stid = oci_parse($conn, $stmt);
					oci_execute($stid);
					
                  echo "<div class=\"alert alert-success\"><strong>Success!</strong> $id , $language is updated.</div>";
                }
              }
              ob_end_flush();
              ?>
              
              <h2 class="form-signin-heading">Update Language</h2>	
              ...
              <input type="language" name="inputLanguage" id="inputLanguage" class="form-control" placeholder="new language" required autofocus>
              <br>
