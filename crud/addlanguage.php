        ...
        <div class="col-md-9">
          ...
          <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
              ...
              <li class="active"><a href="addlanguage.php">Add Language</a></li>
          ...
          <div class="col-sm-9 col-sm-offset-3 col-md-9 col-md-offset-3 main">
            ...
            // Prepare the query
            $stmt = "SELECT MOVIE.MOVIE_ID ,MOVIE.MOVIE_TITLE,LANGUAGE.LANGUAGE
					 FROM LANGUAGE RIGHT JOIN MOVIE ON LANGUAGE.LANGUAGE_ID=MOVIE.MOVIE_ID
		  ...
		  <br><br><br>
			...
			<form class="form-signin" method="POST" action = "addlanguage.php">
              ...
              // Add language
              if (!empty($_POST['inputLanguageID']) && !empty($_POST['inputLanguage']) ){
                $id = ($_POST['inputLanguageID']);
                $language = ($_POST['inputLanguage']);

                // prepare the query
                $stmt = "CALL ADD_LANGUAGE ('$id','$language')";
				$stid = oci_parse($conn, $stmt);
                ...
                if( !oci_execute($stid) ) {
                  ...
                  oci_close($conn);
					...
					$stmt = "CALL ADD_LOG('A new language \"$language\"  with movie id \"$id\" is added at $currentTime on $currentDate.')";
					$stid = oci_parse($conn, $stmt);
					oci_execute($stid);

                  echo "<div class=\"alert alert-success\"><strong>Success!</strong> $language is added as an language.</div>";
                }
              ...
              <label for="inputLanguageID" class="sr-only">Languageid</label>
              <input type="id" name="inputLanguageID" id="inputLanguageID" class="form-control" placeholder="Language id" required autofocus>
              <br>
              <label for="inputLanguage" class="sr-only">Language</label>
              <input type="language" name="inputLanguage" id="inputLanguage" class="form-control" placeholder="Language" required autofocus>
              <br>
