        ...
        <div class="col-md-9">
          ...
          <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
              ...
              <li class="active"><a href="deletedirectorcomment.php">Delete Director Comment</a></li>
              <br>
          ...
          <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-3 main">
            ...
            <h2 class="form-signin-heading">List of Director Comment</h2>
		  ...
		  <br><br><br>
            ...
            <form class="form-signin"  method="POST" action = "deletedirectorcomment.php">
              <h2 class="form-signin-heading">Delete Director Comment</h2>
              <label for="inputDirectorID" class="sr-only">Director ID</label>
              <input type="number" name="inputDirectorID" id="inputDirectorID" class="form-control" placeholder="Director ID" required autofocus>
              <br>
			  ...
			  // Delete movie
              if (!empty($_POST['inputDirectorID'])){
                $id =($_POST['inputDirectorID']);
                // prepare the query
                $stmt = "CALL DELETE_DIRECTOR_COMMENT ('$id','$memberID')";
                $stid = oci_parse($conn, $stmt);
                ...
                if( !oci_execute($stid) ) {
                  ...
                  oci_close($conn);
					...
					$stmt = "CALL ADD_LOG('Director Comment with ID $id is deleted at $currentTime on $currentDate.')";
					$stid = oci_parse($conn, $stmt);
					oci_execute($stid);
