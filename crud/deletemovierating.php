        ...
        <div class="col-md-9">
          ...
          <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
              ...
              <li class="active"><a href="deletemovierating.php">Delete Movie Rating</a></li>
              <br>
			  <!-- 17 actor rating -->
		  ...
		  <br><br><br>
            ...
            <form class="form-signin"  method="POST" action = "deletemovierating.php">
              <h2 class="form-signin-heading">Delete Movie Rate</h2>
              ...
              if (!empty($_POST['inputMovieID'])){
                ...
                // prepare the query
                $stmt = "CALL DELETE_MOVIE_RATING ('$id','$memberID')";
                $stid = oci_parse($conn, $stmt);
