        ...
        <div class="col-md-9">
          ...
          <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
              ...
              <li class="active"><a href="deletedirectorrating.php">Delete Director Rating</a></li>
          ...
          <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-3 main">
            ...
            <h2 class="form-signin-heading">List of Director Ratings</h2>
		  ...
		  <br><br><br>
            ...
            <form class="form-signin"  method="POST" action = "deletedirectorrating.php">
              <h2 class="form-signin-heading">Delete Director Rating</h2>
              <label for="inputDirectorID" class="sr-only">Actor ID</label>
              ...
              if (!empty($_POST['inputDirectorID'])){
                ...
                // prepare the query
                $stmt = "CALL DELETE_DIRECTOR_RATING ('$id','$memberID')";
                $stid = oci_parse($conn, $stmt);
                ...
                if( !oci_execute($stid) ) {
                  ...
                  oci_close($conn);
					...
					$stmt = "CALL ADD_LOG('Director Rate with ID $id is deleted at $currentTime on $currentDate.')";
					$stid = oci_parse($conn, $stmt);
					oci_execute($stid);
