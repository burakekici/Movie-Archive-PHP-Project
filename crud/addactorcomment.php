        ...
        <div class="col-md-9">
          ...
          <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
              ...
              <li class="active"><a href="addactorcomment.php">Add Actor Comment</a></li>
          ...
          <div class="col-sm-9 col-sm-offset-3 col-md-9 col-md-offset-3 main">
			  ...
			  <h2 class="form-signin-heading">List Actor Comment</h2>
		  ...
		  <br><br><br>
			...
			<form class="form-signin" method="POST" action = "addactorcomment.php">
              ...
              if (!empty($_POST['inputActorID']) &&  !empty($_POST['inputActorcomment']) ){
                ...
                // prepare the query
                $stmt = "CALL ADD_ACTOR_COMMENT ('$id','$memberID','$actorcomment')";
				$stid = oci_parse($conn, $stmt);
                ...
                if( !oci_execute($stid) ) {
                  ...
                  oci_close($conn);
					...
					$stmt = "CALL ADD_LOG('A new actor comment \"$actorcomment\"  with actor id \"$id\" member id \"$memberID\" is added at $currentTime on $currentDate.')";
					$stid = oci_parse($conn, $stmt);
					oci_execute($stid);

                  echo "<div class=\"alert alert-success\"><strong>Success!</strong> $actorcomment is added as an actor comment.</div>";
                }
              ...
              <h2 class="form-signin-heading">Add Actor Comment</h2>

              <label for="inputActorID" class="sr-only">Actorid</label>
              <input type="id" name="inputActorID" id="inputActorID" class="form-control" placeholder="Actor id" required autofocus>
              <br>
              <label for="inputActorcomment" class="sr-only">Comment</label>
              <input type="actorcomment" name="inputActorcomment" id="inputActorcomment" class="form-control" placeholder="Comment" required autofocus>
              <br>
			  <button class="btn btn-lg btn-primary btn-block" type="submit">Add actor comment</button>
            </form>
