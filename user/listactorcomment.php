        ...
        <div class="col-md-9">
          ...
          <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
              ...
              <br>
              <!-- 7 genre -->
              <li><a href="listgenre.php">List Genres<span class="sr-only">(current)</span></a></li>
              <br>
              <!-- 8 award -->
              ...
              <br>
			  <!-- 14 actor comment -->
              <li class="active"><a href="listactorcomment.php">List Actor Comments</a></li>
          ...
          <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-3 main">
            ...
            <h2 class="form-signin-heading">List of Actor Comment</h2>
