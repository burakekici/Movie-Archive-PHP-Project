            ...
            <div class="col-md-9">
                ...
                <div class="col-sm-3 col-md-2 sidebar">
                    <ul class="nav nav-sidebar">
						...
						<li class="active"><a href="filter3.php">Filter Actors By Age and Hometown</a></li>                        
						<br>
                ...
                <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-3 main">
                    ...
                    <h2 class="form-signin-heading">Actors by age and hometown</h2>
                    <br>

                    <form method="POST" action="filter3.php">
                        <div class="form-group">
                            ...
                            <div class="col-xs-4 selectContainer">
                                <select class="form-control" name="age">
                                    ...
                                    $stmt = "SELECT DISTINCT ACTOR_AGE FROM ACTOR";
                                    ...
                                    if (!oci_execute($stid)) {
                                        ...
                                        while ($row = oci_fetch_array($stid)) {
                                            echo "<option value= \"" . $row['ACTOR_AGE'] . "\">" . $row['ACTOR_AGE'] . "</option>";
                                        }
                                        echo "</table>";
                                    }
                        ...
                        <input type="radio" name="operator"
                            <?php if (isset($operator) && $operator == "less") echo "checked"; ?>
                               value="less">Younger Than

                        <input type="radio" name="operator"
                            <?php if (isset($operator) && $operator == "greater") echo "checked"; ?>
                               value="greater">Older Than

                        <br><br>

                        <div class="form-group">
                            <label class="col-xs-2 control-label">Hometown</label>
                            <div class="col-xs-4 selectContainer">
                                <select class="form-control" name="hometown">
                                    ...
                                    $stmt = "SELECT DISTINCT ACTOR_HOMETOWN FROM ACTOR";
                                    $stid = oci_parse($conn, $stmt);
                                    ...
                                    if (!oci_execute($stid)) {
                                        ...
                                        while ($row = oci_fetch_array($stid)) {
                                            echo "<option value= \"" . $row['ACTOR_HOMETOWN'] . "\">" . $row['ACTOR_HOMETOWN'] . "</option>";
                                        }
                                        echo "</table>";
                                    }
                        ...
                        if (!empty($_POST['age']) && !empty($_POST['operator']) && !empty($_POST['hometown'])) {
                            ...
                            $selectedhometown = ($_POST['hometown']);


                            // Prepare the query
                            $stmt = "SELECT ACTOR_NAME, ACTOR_SURNAME, ACTOR_AGE, ACTOR_HOMETOWN FROM ACTOR WHERE ACTOR_HOMETOWN LIKE '$selectedhometown' AND ACTOR_AGE $opt $selectedage";
                            $stid = oci_parse($conn, $stmt);
                            ...
                            if (!oci_execute($stid)) {
                                ...
                                echo "<thead> <tr> <th>Actor Name</th> <th>Surname</th> <th>Age</th> <th>Hometown</th>";
                                // Print the results
