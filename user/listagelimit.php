        ...
        <div class="col-md-9">
          ...
          <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
              ...
              <br>
              <!-- 6 age_limit -->
              <li class="active"><a href="listagelimit.php">List Age Limits<span class="sr-only">(current)</span></a></a></li>
              <br>
              <!-- 7 genre -->
          ...
          <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-3 main">
            ...
            // Prepare the query
            $stmt = "SELECT al.AGELIMIT_ID,m.MOVIE_TITLE,al.AGELIMIT FROM AGELIMIT al,MOVIE m WHERE al.AGELIMIT_ID=m.MOVIE_ID  ORDER BY AGELIMIT_ID";
            ...
            if( !oci_execute($stid) ) {
              ...
              echo "<thead> <tr> <th>ID</th> <th>Movie</th> <th>Age Limits</th> </tr> </thead>";
              // Print the results
