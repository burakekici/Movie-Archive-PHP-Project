            ...
            <div class="col-md-9">
                ...
                <div class="col-sm-3 col-md-2 sidebar">
                    <ul class="nav nav-sidebar">
                        ...
                        <br>
                        <li class="active"><a href="listshortestmovies.php">List Shortest Movies</a></li>
                ...
                <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-3 main">
                    ...
                    <h2 class="form-signin-heading">List of Shortest Movies</h2>
                    ...
                    // Prepare the query
                    $stmt = "SELECT * FROM SHORTEST_MOVIES";
                    ...
                    if (!oci_execute($stid)) {
                        ...
                        echo "<thead> <tr> <th>Movie Title</th> <th>Movie Length(mins)</th>";
                        // Print the results
                    ...
                    if (isset($_POST['html'])) {
                        ...
                        if (!oci_execute($stid)) {
                            ...
                            $stringData .= "<thead> <tr> <th>Movie Title</th> <th>Movie Length(mins)</th>";
                            // Print the results
                            while ($row = oci_fetch_array($stid, OCI_ASSOC + OCI_RETURN_NULLS)) {
                                $stringData .= "<tr>\n";
                                foreach ($row as $item) {
