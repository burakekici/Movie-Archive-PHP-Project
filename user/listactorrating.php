      ...
      <div class="row">
        <div class="col-md-9">
          ...
          <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-3 main">
            ...
            <h2 class="form-signin-heading">List of Actor Rate</h2>
            ...
            // Prepare the query
            $stmt = "SELECT ACTOR_RATING.ACTOR_ID,ACTOR.ACTOR_NAME,ACTOR_RATING.MEMBER_ID,MEMBER.MEMBER_NAME,ACTOR_RATING.ACTOR_RATING
