        ...
        <div class="col-md-9">
          ...
          <div class="col-sm-3 col-md-2 sidebar">
            <ul class="nav nav-sidebar">
              ...
              <br>
			  <!-- 11 movie actor -->
              <li class="active"><a href="../user/listmovieactor.php">List Movie Actors</a></li>
          ...
          <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-3 main">
			...
			<h2 class="form-signin-heading"></h2>	
			  <form class="form-signin"  method="POST" action = "listmovieactor.php">
			  <label for="inputMovieId" class="sr-only">Movieid</label>
              <input type="id" name="inputMovieId" id="inputMovieId" class="form-control" placeholder="Enter the movie ID you want to view actors" required autofocus>
              <br>
              <button class="btn btn-lg btn-primary btn-block" type="submit">List actors</button>
            ...
            // Prepare the query  (select * from tablo where id=’$GET[“id”]’)
            $stmt = "SELECT m.MOVIE_TITLE FROM ACTOR a,MOVIE m WHERE m.MOVIE_ID=’$_POST[inputMovieId]’ ORDER BY m.MOVIE_ID ";
